...
Critical Constraints (Highest Priority - Do Not Deviate from these principles):
    ...
    1. Hairstyle Fidelity (Primary Priority): The target hairstyle description is paramount and must be replicated with complete accuracy. Every specific detail—including hair type, texture, braid count, thickness, length, parting, fades, color, and styling—must be faithfully rendered. The hairstyle's shape, volume, and structure must be adapted to fit realistically onto the subject's head in its original, unchanged position.
    ...
    9. Prioritization Hierarchy: When conflicts arise between constraints, follow this priority order:
        ◦ First: Original Image Preservation (Constraint #2) - especially Head Position, Body Position, and Facial Hair.
        ◦ Second: Override Rules (Constraints #3 & #4) - Ignore all viewing angle and facial hair descriptions.
        ◦ Third: Hairstyle Fidelity (Constraint #1) - Replicate the described hairstyle as accurately as possible while fitting it to the original pose.
        ◦ Fourth: Photorealism & Seamless Integration (Constraints #7 & #8).
